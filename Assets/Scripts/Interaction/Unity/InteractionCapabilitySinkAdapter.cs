...
namespace CUC260905.Interaction
{
    ...
    public sealed class InteractionCapabilitySinkAdapter : MonoBehaviour,
        IInteractionIntentSink<ClickIntent>,
        IInteractionIntentSink<DragIntent>,
        IInteractionIntentSink<HoverIntent>
    {
