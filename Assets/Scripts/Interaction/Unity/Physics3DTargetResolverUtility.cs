...
namespace CUC260905.Interaction
{
    ...
    public interface IInteractionTargetResolverUtility : IUtility
    {
    ...
    /// </summary>
    public sealed class Physics3DTargetResolverUtility : IInteractionTargetResolverUtility
    {
        ...
        public Physics3DTargetResolverUtility(
            Camera camera,
            LayerMask layerMask,
            float maxDistance)
        {
